...
func Test_New(t *testing.T) {
	...
	prev, isFull = rb.Push("Event 3")
	testhelpers.AssertEqual(t, prev, "")
	testhelpers.AssertEqual(t, isFull, false)

	prev, isFull = rb.Push("Event 4")
	testhelpers.AssertEqual(t, prev, "")
	testhelpers.AssertEqual(t, isFull, false)

	prev, isFull = rb.Push("Event 5")
	testhelpers.AssertEqual(t, prev, "")
	testhelpers.AssertEqual(t, isFull, false)

	prev, isFull = rb.Push("Event 6")
